const posters = [
  { owner: "Alice", career: "Accountant", zh: "會計師", thumb: "alice.pdf.png" },
  { owner: "Alina", career: "Air Catering Quality Control Specialist", zh: "航空餐食品管專員", thumb: "alina.pdf.png" },
  { owner: "Ann", career: "Izakaya Chef", zh: "居酒屋廚師", thumb: "ann.pdf.png" },
  { owner: "Celine", career: "Bridal Makeup Artist", zh: "新娘秘書", thumb: "celine.pdf.png" },
  { owner: "Melody", career: "Equipment Engineer", zh: "設備工程師", thumb: "melody.pdf.png" },
  { owner: "Patty", career: "Veterinarian", zh: "獸醫", thumb: "patty.pdf.png" },
  { owner: "Phoebe", career: "Elementary School Teacher", zh: "國小教師", thumb: "phoebe.pdf.png" },
  { owner: "Sydney", career: "APR Engineer", zh: "APR 後端工程師", thumb: "sydney.pdf.png" },
  { owner: "譚芯", career: "Bridal Makeup Artist", zh: "新娘秘書", thumb: "tan-xin.pdf.png" },
  { owner: "李采恩", career: "Elementary School Teacher", zh: "國小教師", thumb: "tsai-en-li.pdf.png" },
];
...
function openPoster(poster) {
  ...
  posterFrame.src = poster.thumb;
  posterLink.href = poster.thumb;
  posterLink.textContent = "開啟海報圖片";
  dialog.showModal();
}
